...
<h2><?php echo WPMBG_DISPLAY_NAME ?> Infographics Given To Me</h2>
...
<input type="button" class="button" id="wpmbg_search_igmt_submit" value="Search" /><span class="loading" style="display:none"> <img src="<?php echo WPMBG_IMGS ?>/loading.gif" /></span><span id="wpmbg_search_status"></span>
</div>
...
<input class="button" type="button" name="wpmbg_search_prev" id="wpmbg_search_igmt_prev" value="Prev"/>
</span>
<span id="wpmbg_next_area">
<input class="button" type="button" name="wpmbg_search_next" id="wpmbg_search_igmt_next" value="Next"/>
